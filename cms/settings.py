...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Puts the unread notification count in every template, for
                # the bell in base.html. See complaints/context_processors.py.
                'complaints.context_processors.notifications',
            ],
        },
    },
]
